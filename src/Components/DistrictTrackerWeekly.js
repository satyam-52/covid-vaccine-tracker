...
function DistrictTrackerWeekly() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    fetch(
      `https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/calendarByDistrict?district_id=${districtId}&date=${dateFormat()}`
    ).then((res) => {
      res.json().then((val) => {
...
export default DistrictTrackerWeekly;
